...
public class Member extends User {
    ...
    public Member(int userId, String userFname, String userLname, String userSex, String userPhone,
            String userEmail, String userPwd, String userRole, boolean userStatus, Timestamp createdAt) {
        super(userId, userFname, userLname, userSex, userPhone, userEmail, userPwd, userRole, userStatus, createdAt);
    }
